...
public class CommentApiComment {

    private final CommentService commentService;

    @PostMapping("/api/comment")
    private ResponseEntity<?> commentSave(@RequestBody CommentDto commentDto, @AuthenticationPrincipal PrincipalDetails principalDetails) {
